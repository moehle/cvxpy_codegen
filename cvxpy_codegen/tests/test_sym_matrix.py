...
A_param = sym.as_sym_matrix(cvx.Parameter((m, n), value=A_dense))

B_sparse  = sp.rand(n,p, dens)
B_sym = sym.as_sym_matrix(B_sparse)
B_dense = B_sparse.toarray()
B_param = sym.as_sym_matrix(cvx.Parameter((n, p), value=B_dense))

C_sparse  = sp.rand(m,n, dens)
C_sym = sym.as_sym_matrix(C_sparse)
C_dense = C_sparse.toarray()
C_param = sym.as_sym_matrix(cvx.Parameter((m, n), value=C_dense))
